---
title: Implementação UDP - Peso 1
sidebar_position: 5
slug: /pond5
---
...
Utilizando SOCKETs e a linguagem de sua escolha, implemente a comunicação UDP
de acordo com a [especificação](https://datatracker.ietf.org/doc/html/rfc768)
